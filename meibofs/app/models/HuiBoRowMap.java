...
public class HuiBoRowMap implements RowMapper{

	
	public HuiBo mapRow(ResultSet rs, int index) throws SQLException {
		// TODO Auto-generated method stub
		
		HuiBo bean = new HuiBo();
		
		bean.hbp_id=rs.getLong("hbp_id");
