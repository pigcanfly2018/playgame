...
public class YingTongBaoRowMap implements RowMapper{

	
	public YingTongBao mapRow(ResultSet rs, int index) throws SQLException {

		YingTongBao bean = new YingTongBao();
		bean.ytbp_id=rs.getLong("ytbp_id");
