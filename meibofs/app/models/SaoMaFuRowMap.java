...
public class SaoMaFuRowMap implements RowMapper{

	
	public SaoMaFu mapRow(ResultSet rs, int index) throws SQLException {
		// TODO Auto-generated method stub
		
		SaoMaFu bean = new SaoMaFu();
		
		bean.smfp_id=rs.getLong("smfp_id");
