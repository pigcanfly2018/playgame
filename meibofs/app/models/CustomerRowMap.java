...
public class CustomerRowMap implements RowMapper{
	public Customer mapRow(ResultSet rs, int index) throws SQLException {
		...
		bean.bbinmobile_flag=rs.getBoolean("bbinmobile_flag");
		...
		String reg_domain = StringUtils.trimToEmpty(rs.getString("reg_domain"));
		String refer_url = StringUtils.trimToEmpty(rs.getString("refer_url"));
		String search_key = StringUtils.trimToEmpty(rs.getString("search_key"));
		
		bean.reg_info = reg_domain+";  "+refer_url+";  "+search_key;
