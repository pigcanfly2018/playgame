...
public class XunHuiBaoRowMap implements RowMapper{

	public XunHuiBao mapRow(ResultSet rs, int index) throws SQLException {
		XunHuiBao bean = new XunHuiBao();
		
		bean.xfbp_id=rs.getLong("xfbp_id");
