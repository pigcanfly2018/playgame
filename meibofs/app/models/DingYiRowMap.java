...
public class DingYiRowMap implements RowMapper{

	
	public DingYi mapRow(ResultSet rs, int index) throws SQLException {

		DingYi bean = new DingYi();
		bean.dybp_id=rs.getLong("dybp_id");
