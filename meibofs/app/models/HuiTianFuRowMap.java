...
public class HuiTianFuRowMap implements RowMapper{
	public HuiTianFu mapRow(ResultSet rs, int index) throws SQLException {
		HuiTianFu bean = new HuiTianFu();
		bean.htp_id=rs.getLong("htp_id");
		...
		bean.return_url=rs.getString("return_url");
		return bean;
	}
}
