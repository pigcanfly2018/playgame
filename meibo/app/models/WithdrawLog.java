...
public class WithdrawLog {
	     ...
	     public  Long NTcreat(){
			  final String sql="insert into  mb_withdraw_log (pre_status,after_status,withdraw_id,remarks,create_date,create_user) "
			  		+ "values(?,?,?,?,now(),?)";
			  final Object[] objects=new Object[]{pre_status,after_status,withdraw_id,remarks,create_user};
	     ...
	     public static List<WithdrawLog> NTgetLogsByWit(Long withdraw_id){
	     	String sql="select * from mb_withdraw_log where withdraw_id =? ";
