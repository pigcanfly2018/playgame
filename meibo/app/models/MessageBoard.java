...
public class MessageBoard {
    ...
    public  boolean NTcreat(){
		  String sql="insert into  sb_message_board (cust_name,question,reply,create_date," +
	 ...
	 public  boolean NTupdate(){
		  String sql="update sb_message_board set cust_name=?,question=?,reply=?,reply_user=?,reply_date=now()," +
	 ...
	 public static boolean NTdelete(Long id){
		  String sql="delete from  sb_message_board where msg_id=?";
