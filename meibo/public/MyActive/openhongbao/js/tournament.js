...
(747,115-122): run-time error JS1019: Can't have 'break' outside of loop: break a
 */
...
! function (a) {
	...
	function b(b, e) {
		...
		function k(b, d) {
			o.hasContentToSroll && (a("body").addClass("noSelect"), z = d ? t.offset()[y] : w ? b.pageX : b.pageY, u && (document.ontouchmove = function (a) {
				(o.options.touchLock || i() && j()) && a.preventDefault(), a.touches[0][c + "Touch"] = 1, m(a.touches[0])
		...
		function m(a) {
			if (o.hasContentToSroll) {
				var d = w ? a.pageX : a.pageY,
					e = a[c + "Touch"] ? z - d : d - z,
					f = Math.min(o.trackSize - o.thumbSize, Math.max(0, o.thumbPosition + e));
				o.contentPosition = f * o.trackRatio, b.trigger("move"), t.css(y, f), q.css(y, -o.contentPosition)
			}
		}
