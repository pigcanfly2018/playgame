...
public class XunFuTongService {

	private static Logger logger=Logger.getLogger(XunFuTongService.class);
	
    private JdbcTemplate template;
	private String datasource;
		
	public XunFuTongService(JdbcTemplate template,String datasource){
