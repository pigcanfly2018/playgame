...
public class YingTongBaoPayService {
	 ...
	 private static Logger logger=Logger.getLogger(YingTongBaoPayService.class);
		
	    private JdbcTemplate template;
		private String datasource;
			
		public YingTongBaoPayService(JdbcTemplate template,String datasource){
		...
		public  Long createYtbp(String pay_id,String login_name,
			  ...
			  String sql="insert into mb_ytbp(pay_id,login_name,amount,payip,pay_method,remark,"
		...
		public boolean isNotDoYdp(String pay_id){
			 String sql="select count(1) from mb_ytbp where state= 0 and pay_id =?  ";
		...
		public String queryLoginname(String pay_id){
			 String sql="select login_name from mb_ytbp  where pay_id=? ";
			 Object[] objs=new Object[]{pay_id};
			 logger.info(LogHelper.dbLogObj(datasource,sql,Arrays.asList(objs)));
		...
		public boolean updaete(String pay_id,String orderNo,String remark,String state,BigDecimal amount,BigDecimal rate){
			 String sql="update mb_ytbp set order_no=?,remark=?, state=?,  "
