...
public class HuiTongService {
	...
	private static Logger logger=Logger.getLogger(HuiTongService.class);
	
	private JdbcTemplate template;
	private String datasource;
	
	public HuiTongService(JdbcTemplate template,String datasource){
		this.template=template;
		this.datasource=datasource;
	}
	
	public  Long createCfp(String pay_id,String login_name,
	...
	public String queryPayType(String pay_id){
		 String sql="select pay_method from mb_smfp  where pay_id=? ";
		 Object[] objs=new Object[]{pay_id};
		 logger.info(LogHelper.dbLogObj(datasource,sql,Arrays.asList(objs)));
