...
public class YbpService {
	private static Logger logger=Logger.getLogger(YbpService.class);
	
	private JdbcTemplate template;
	private String datasource;
			
	public YbpService(JdbcTemplate template,String datasource){
	 ...
	 * @return
	 */
	public boolean updaeteYdp(String pay_id,String orderNo,String state,BigDecimal amount,String channel){
