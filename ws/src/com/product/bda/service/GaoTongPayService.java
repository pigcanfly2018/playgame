...
public class GaoTongPayService {

	
	private static Logger logger=Logger.getLogger(GaoTongPayService.class);
	
	private JdbcTemplate template;
	private String datasource;
			
	public GaoTongPayService(JdbcTemplate template,String datasource){
