...
public class ScanUtil {
	    ...
	    private Logger logger = LoggerFactory.getLogger(ScanUtil.class);
	     ...
	     */
	    public ScanUtil(String basePackage, ClassLoader cl) {
	        this.basePackage = basePackage;
	        this.cl = cl;
	    }
	    ...
	    public static void main(String[] args) throws Exception {
	    	ScanUtil scan = new ScanUtil("bsz.exch.handler");
